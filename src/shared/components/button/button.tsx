...
const variantStyles: Record<ButtonVariant, string> = {
  primary: [
    'bg-linear-to-br from-brand-primary-500 to-brand-primary-400 text-neutral-0',
    'hover:bg-brand-primary-600 hover:bg-none',
    'active:bg-brand-primary-700 active:bg-none',
    'disabled:bg-neutral-200 disabled:text-neutral-400 disabled:bg-none',
  ].join(' '),
  secondary: [
