  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="lg:col-span-2 bg-brand-primary-500 text-neutral-0 rounded-xl p-6 lg:p-8">
        <p className="text-label-lg text-neutral-0/70 mb-2">접수중인 청약</p>
            ...
            {accepting.slice(0, 2).map((sub) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  <p className="text-label-lg text-neutral-0 truncate">{sub.name}</p>
        ...
        <Link
          href="/listings"
          className="inline-flex items-center gap-1 mt-4 text-label-lg text-neutral-0/80 hover:text-neutral-0 transition-colors"
        >
